...
import (
	...
	"github.com/NiekKloppenburg/greenlight/internal/mailer"
...
func main() {
	...
	flag.StringVar(&cfg.db.dsn, "db-dsn", "postgres://greenlight:pa55word@localhost/greenlight", "Postgres-DSN")
	...
	flag.StringVar(&cfg.smtp.username, "smtp-username", "2d4d00b01c55f2", "SMTP username")
